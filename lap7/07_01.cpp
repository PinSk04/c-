...
#include <string.h>
using namespace std;
void CalGrade(int &name , int &lastname ,int &classroom , int &homework , int &test, int &midterm , int &final);
...
int main(){
    ...
    for ( int i = 0; i < std; i++)
    {
        CalGrade (name[i],lastname[i],classroom[i],homework[i],test[i],midterm[i],final[i]);
